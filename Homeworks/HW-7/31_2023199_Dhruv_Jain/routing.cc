...
void RunSimulation(bool useRip)
{
    ...
    Ptr<Node> n7 = nodes.Get(6);
    Ptr<Node> n8 = nodes.Get(7);
    ...
    //NetDeviceContainer d_n3n6 = p2p.Install(n3, n6);  // used in Q-3 
    NetDeviceContainer d_n5n6 = p2p.Install(n5, n6);
    NetDeviceContainer d_n2n4 = p2p.Install(n2, n4);
    NetDeviceContainer d_n3n7 = p2p.Install(n3, n7);
    NetDeviceContainer d_n7n8 = p2p.Install(n7, n8);
    NetDeviceContainer d_n8n6 = p2p.Install(n8, n6);
